...
<!--    <Quote :quote="tquote" />-->
    <div id="container">
      <h1 style="direction: RTL">&bull;  اختبر مدى احتمالية تعرض اسم طفلك لإشكالية تشابه الأسماء ✌️  &bull;</h1>
      <div class="underline">
      </div>
      <div class="icon_wrapper">
        <svg class="icon" id="meter"  xmlns="http://www.w3.org/2000/svg" height="145.3125pt" version="1.1" viewBox="0 0 145.3125 145.3125" width="145.3125pt">
          <g id="surface1">
  ...
  <div class="sign">
    طُور بواسطة / <a href="mailto:m.ezz.ibr@gmail.com" >محمد عزالدين</a>
  </div>
  </div>
</template>
  ...
  async gen() {
    ...
    if (freq >= 2) {
      document.getElementById('result').innerHTML =
        ' احتمالية التشابه مرتفعة جدًا، على الأغلب يوجد هناك ' +  "<br> " + "<strong>" + freq*2000 + "</strong>" + " " + "شخص بنفس الاسم، وقد يوجد من بينهم حوالي" + " " + "<strong>" + (freq*2000)*(0.001) + "</strong>" + " " + "  مُدان بأحكام قضائية "
       document.getElementById('meter').style.fill = '#bb2121'
    }
    else if (freq <= 1) {
      document.getElementById('result').innerHTML =
        ' احتمالية التشابه منخفضة، اختيار هذا الاسم سوف يكون اختيارًا آمنًا بإذن الله ' 
         document.getElementById('meter').style.fill = '#30b35a'
    }
